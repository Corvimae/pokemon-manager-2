...
<div class="sheet">
	...
	<div class="top-item-group">
		<div class="top-item"><div class="item large-item"></div><div class="item-desc">CHARACTER NAME</div></div>
		<div class="top-item"><div class="item large-item"></div><div class="item-desc">PLAYER</div></div>
	</div>
	<div class="top-item-group">
		<div class="top-item"><div class="item med-item" style="font-size: 1.0em"></div><div class="item-desc">CLASS AND LEVEL</div></div>
		<div class="top-item"><div class="item short-item" style="font-size: 1.0em"></div><div class="item-desc">RACE</div></div>
		<div class="top-item"><div class="item short-item" style="font-size: 1.0em"></div><div class="item-desc">ALIGNMENT</div></div>
		<div class="top-item"><div class="item short-item" style="font-size: 1.0em"></div><div class="item-desc">DEITY</div></div>
	</div>
	<div class="top-item-group">
	...
	<div class="stats">
		...
		<div class="stats-row">
			...
			<div class="stat-box"></div><div class="stat-box"></div>
	...
	<div class="top-stats">
		...
		<div class="hp-box"></div><div class="hp-box-large"></div>
		...
		<div class="ev-box"></div><div class='symbol plus'>+</div>		
		<div class="ev-box"></div><div class='symbol plus'>+</div>
		<div class="ev-box"></div><div class='symbol plus'>+</div>
	...
	<div class="ac-mods">
		...
		<div class="hp-box"></div><div class='symbol'>=</div>
		<div class="ev-box" style="left: 10px"></div><div class='symbol'>+</div>
	...
	<div class="saves">
		...
		<div class="stats-row">
			...
			<div class="stat-box" style="margin-right: 0px"></div><div class="symbol">=</div>
			<div class="ev-box save-box">0</div><div class='symbol plus'>+</div>
			<div class="ev-box save-box"></div><div class='symbol plus'>+</div>
			<div class="ev-box save-box">0</div><div class='symbol plus'>+</div>
			<div class="ev-box save-box">0</div><div class='symbol plus'>+</div>
	...
	<div class="bab-section">
		...
		<div class="stat-box" style="margin-top: 2px; margin-right: 0px;"></div><div class="symbol">=</div>
		<div class="ev-box save-box">0</div><div class='symbol plus'>+</div>
		<div class="ev-box save-box"></div><div class='symbol plus'>+</div>
		<div class="ev-box save-box">0</div><div class='symbol plus'>+</div>
	...
	<div class="attacks">
		...
		<div class="attack-shell">
			...
			<div style="clear: both;"></div>
			<div class="attack-content" style="border-left: 2px solid #000"></div>
			<div class="attack-content" style="width: 170px;"></div>
			<div class="attack-content" style="width: 100px;"></div>
			...
			<div class="attack-content" style="width: 100px; border-bottom: 2px solid #000"></div>
			<div class="attack-content" style="border-right: 2px solid #000; width: 419px; border-bottom: 2px solid #000"></div>
			<div style="clear: both;"></div>
	...
	@foreach($skills as $s)
		<div class="skill-row">
			...
			<div class="skill-ability">{{$s['key']}}</div><div class="skill-modifier-box"></div><div class="skill-equals">=</div><div class="skill-ability-mod"></div><div class="skill-plus-1">+</div>
			<div class="skill-ranks"></div><div class="skill-plus-2">+</div><div class="skill-misc-mod"></div>
		</div>
	@endforeach
